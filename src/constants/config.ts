export const CONFIG = {
  ...
  language: 'Abenaki', // This changes the display name for your language
  wordLength: 5, // This sets how long each word is based on how many characters (as defined in orthography.ts) are in each word
  author: 'Joseph Anthony Francis Medeiros (Callahan Tondreau)', // Put your name here so people know who made this Wordle!
  authorWebsite: 'jafmedeiros', // Put a link to your website or social media here
  wordListSource: 'Joseph Laurent Dictionary Online', // Describe the source material for your words here
  wordListSourceLink: 'https://www.canadiana.ca/view/oocihm.08895/5?r=0&s=1', // Put a link to the source material for your words here
  //
